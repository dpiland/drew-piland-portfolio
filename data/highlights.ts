export const highlights: string[] = [
  "Led GTM strategy for 30+ major product launches across enterprise B2B markets — DevOps, CDN, cloud infrastructure, and edge computing",
  "Built messaging frameworks adopted by 500+ person sales orgs globally, improving deal velocity and rep confidence",
  "Drove C-suite alignment across 20+ engagements, delivering executive narratives used in board presentations, investor briefings, and analyst evaluations",
