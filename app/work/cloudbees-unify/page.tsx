      ...
      <main>
        ...
        >
          ...
          <p>
            ...
            in common use. And{" "}
            <strong className="text-white font-semibold">
              it was a risk argument rather than a preference.
            </strong>{" "}
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-6">
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              execution layer where they actually run.{" "}
              <strong className="text-white font-semibold">
                Collapse those into one word and the whole reposition reads as
                new packaging on the product we already sold.
              </strong>
            </p>
          </div>
        ...
        >
          <p>
            ...
            webinar series, the campaigns, and the sales plays were all{" "}
            <strong className="text-white font-semibold">
              built off it rather than each writing their own version.
            </strong>
          </p>
          ...
          <p>
            Then the internal half, which is the part that{" "}
            <strong className="text-white font-semibold">
              decides whether a message survives past launch week.
            </strong>
          </p>
          ...
          <p>
            ...
            their problems, and{" "}
            <strong className="text-white font-semibold">
              you can&apos;t sell to a problem you can&apos;t locate.
            </strong>
          </p>
          ...
          <p>
            <strong className="text-white font-semibold">
              The organizing rule was embrace, don&apos;t replace.
            </strong>{" "}
            Name the one stage we genuinely owned, and everywhere else connect
            to what the customer already ran instead of pitching a rip and
            replace. A rep who can place a stated pain onto a stage knows in the
            same instant whether we have an earned claim, an embrace claim, or
            no claim at all.
          </p>
        ...
        >
          <p>
            ...
            by feature, prioritized by engineering capacity, and{" "}
            <strong className="text-white font-semibold">
              that gap comes due the first time a customer asks the platform to
              behave like one.
            </strong>{" "}
          ...
          <p>
            ...
            <strong className="text-white font-semibold">
              Getting that timing right mattered: it&apos;s what carried into
              how the messaging evolved for our SKO in February 2026.
            </strong>
          </p>
          <p>
            The smaller one I keep relearning is to validate with customers
            before the internal moment, not after. And{" "}
            <strong className="text-white font-semibold">
